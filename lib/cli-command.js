...
${postCreateInstructions(createOptions)}`);
  ...
  options: [{
    ...
    description: 'The name of the object to be exported by the JavaScript and by the native code. Default: (prefix)(name in PascalCase)',
  }, {
    command: '--module-prefix [modulePrefix]',
    description: 'The module prefix for the library module package name, ignored if --module-name is specified',
